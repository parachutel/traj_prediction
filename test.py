...
for input_seq, input_masks, input_edge_types, pred_seq in data_loader:
    ...
    training_loss = predictor.get_training_loss(input_seq, input_edge_types, pred_seq)
    print('training loss =', training_loss)
    nll_q_is, nll_p, nll_exact = predictor.get_eval_loss(input_seq, input_edge_types, pred_seq,
                                                         compute_naive=True,
                                                         compute_exact=True)
    ...
    sampled_future, z_p_samples = predictor.predict(input_seq, input_edge_types, 
